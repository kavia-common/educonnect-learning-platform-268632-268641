 ...
 * Similar to student profile; allows updating avatar and profile fields.
 */
export default function InstructorSettings() {
  /** Render profile settings for instructor role. */
    ...
    async function load() {
      ...
      try {
        const { data, error } = await supabase
          .from("profiles")
          .select("full_name, about, country, avatar_url")
          .eq("id", user.id)
          .maybeSingle();
  ...
  return (
    <div className="container">
      <div className="card">
        <h2 style={{ marginTop: 0 }}>Instructor Settings</h2>
        <p style={{ marginTop: 0, color: "#6b7280" }}>Manage your profile and avatar</p>
      </div>
            ...
            <div>
              ...
              <textarea
                ...
                style={{
                  ...
                  borderRadius: 10,
                  padding: "10px 12px",
                  border: `1px solid ${errors.about ? "var(--color-error)" : "#e5e7eb"}`,
                }}
              />
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...
                  borderRadius: 10,
                  padding: "10px 12px",
                  border: `1px solid ${errors.country ? "var(--color-error)" : "#e5e7eb"}`,
                }}
              />
